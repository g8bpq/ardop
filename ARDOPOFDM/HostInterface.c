...
void ProcessCommandFromHost(char * strCMD)
{
	...
	if (strcmp(strCMD, "ARQBW") == 0)
	{
		...
		{
			// Accept ARDOPC style BW settings as nearest equivalents
			
			if (strcmp(ptrParams, "500MAX") == 0)
				strcpy(ptrParams, "500");
			else if (strcmp(ptrParams, "2000MAX") == 0)
				strcpy(ptrParams, "2500");
